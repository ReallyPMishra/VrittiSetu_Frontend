...
const Job = (props:any) => {
    ...
    return <div data-aos="zoom-out" className="w-2/3 bs-mx:w-full">
        ...
        <div>
            ...
            <div className="text-mine-shaft-300 text-justify xs-mx:text-sm">It is a multinational company (MNC) that operates across multiple countries and offers a wide range of services to customers worldwide. The company provides solutions in areas such as online retail, technology, cloud computing, digital entertainment, and logistics. Known for innovation and customer-focused services, it continuously improves efficiency and convenience through advanced technology.</div>
        </div>
    </div>
}
export default Job;