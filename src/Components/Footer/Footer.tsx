import { IconBriefcase, IconBrandFacebook, IconBrandGithub, IconBrandInstagram, IconBrandLinkedin, IconBrandTelegram, IconBrandX, IconBrandYoutube } from "@tabler/icons-react";
    ...
    return location.pathname!='/signup' && location.pathname!='/login'?<div className="flex flex-col gap-2"><div className="pt-20 pb-5 bg-mine-shaft-950 p-4  flex gap-8 justify-around flex-wrap">
        <div data-aos="fade-up"  data-aos-offset="0"  className="w-1/4 sm-mx:w-1/3   xs-mx:w-1/2 xsm-mx:w-full flex flex-col gap-4">
            <div className="flex gap-1 items-center text-bright-sun-400">
                <IconBriefcase className="xs-mx:hidden text-3xl font-semibold h-6 w-6 text-orange-500" stroke={2.5}/>
                <div className="text-xl font-semibold bg-gradient-to-r from-orange-500 via-white to-green-500 bg-clip-text text-transparent drop-shadow-md">
  VrittiSetu
</div>
            </div>
            ...
            <div className="flex gap-3 text-bright-sun-400 [&>a]:bg-mine-shaft-900 [&>a]:p-2 [&>a]:rounded-full [&>a]:cursor-pointer hover:[&>a]:bg-mine-shaft-700">
                <a href="https://www.instagram.com/pawan_codes/"><IconBrandInstagram /></a>
                <a href="https://www.linkedin.com/in/reallypmishra"><IconBrandLinkedin /></a>
                <a href="https://www.youtube.com/@ReallyPawanMishra"><IconBrandYoutube /></a>
                <a href="https://github.com/ReallyPMishra"><IconBrandGithub/></a>
            </div>
        </div>
        {
    ...
    <div data-aos="flip-left"  data-aos-offset="0" className="font-medium text-center p-5">
        Designed & Programmed By <a className="text-bright-sun-400 hover:underline font-semibold " href="https://www.linkedin.com/in/reallypmishra">Pawan Kumar Mishra</a>
    </div>
    </div>:<></>
}
