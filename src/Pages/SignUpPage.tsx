...
<Login/>
        <div className={`w-1/2 h-[100vh] sm-mx:hidden  sm-mx:min-h-full transition-all duration-1000 flex  items-center  gap-5 justify-center flex-col ${location.pathname=='/signup'?'rounded-r-[200px]':'rounded-l-[200px]'} bg-mine-shaft-900`}>
            <div className="flex gap-1 items-center bg-gradient-to-r from-[#FF9933] via-white to-[#138808] bg-clip-text text-transparent font-semibold">
                <IconBriefcase
  className="xs-mx:hidden text-3xl font-semibold h-16 w-16 text-orange-500" stroke={2.5}/>
                <div className="text-6xl bs-mx:text-5xl md-mx:text-4xl sm-mx:text-3xl font-semibold">VrittiSetu</div>
            </div>
